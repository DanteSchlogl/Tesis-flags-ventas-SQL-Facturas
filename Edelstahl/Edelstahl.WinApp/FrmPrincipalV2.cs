...
namespace Edelstahl.WinApp
{
    public partial class FrmPrincipalV2 : Form
    {
        ...
        private Button btnRespaldoDatos;
        ...
        private void CrearSidebar()
        {
            ...
            btnRespaldoDatos = CrearBotonMenu(480);
            btnRespaldoDatos.Click += BtnRespaldoDatos_Click;
        }
        ...
        private void CrearHeader()
        {
            ...
            cboIdioma.SelectedIndexChanged +=
                CboIdioma_SelectedIndexChanged;
        ...
        private void CboIdioma_DrawItem(
            object sender,
            DrawItemEventArgs e)
        {
            e.DrawBackground();
            ...
            if (e.Index < 0 ||
                e.Index >= cboIdioma.Items.Count)
            {
                return;
            }

            IdiomaItem idioma =
                cboIdioma.Items[e.Index] as IdiomaItem;
        ...
        {
            for (int indice = 0;
                indice < cboIdioma.Items.Count;
                indice++)
            {
                IdiomaItem idioma =
                    cboIdioma.Items[indice] as IdiomaItem;
                ...
                {
                    cboIdioma.SelectedIndex = indice;
                    return;
                }
            }
        ...
        private void CboIdioma_SelectedIndexChanged(
            object sender,
            EventArgs e)
        {
            if (_cambiandoIdioma)
            ...
            IdiomaItem idioma =
                cboIdioma.SelectedItem as IdiomaItem;
            ...
            catch (Exception ex)
            {
                MessageBox.Show(
                    ex.Message,
                    LanguageService.Translate("Idioma"),
        ...
        {
            Text =
                LanguageService.Translate("TituloAplicacion");

            lblTituloAplicacion.Text =
                LanguageService.Translate("TituloAplicacion");

            lblModulo.Text =
                LanguageService.Translate("ModuloVentas");

            lblIdioma.Text =
                LanguageService.Translate("Idioma") + ":";

            btnVentasPedidos.Text =
                "📋 " +
                LanguageService.Translate("VentasPedidos");

            btnProduccion.Text =
                "🏭 " +
                LanguageService.Translate("Produccion");

            btnComprasStock.Text =
                "📦 " +
                LanguageService.Translate("ComprasStock");

            btnLogistica.Text =
                "🚚 " +
                LanguageService.Translate("Logistica");

            btnFinanzas.Text =
                "💰 " +
                LanguageService.Translate("Finanzas");

            btnAtencionCliente.Text =
                "🎧 " +
                LanguageService.Translate("AtencionCliente");

            btnRespaldoDatos.Text =
                "💾 " +
                LanguageService.Translate("RespaldoDatos");

            PnlHeader_Resize(pnlHeader, EventArgs.Empty);
        }

        private void BtnVentasPedidos_Click(
            object sender,
            EventArgs e)
        {
            CargarDashboardVentas();
        ...
        private void BtnRespaldoDatos_Click(
            object sender,
            EventArgs e)
        {
            using (FrmRespaldoDatos formulario =
                new FrmRespaldoDatos())
            {
        ...
        private void CargarDashboardVentas()
        {
            ...
            UcVentasDashboard dashboard =
                new UcVentasDashboard
                {
                    Dock = DockStyle.Fill
                };
        ...
        private void FrmPrincipalV2_FormClosed(
            object sender,
        ...
        private sealed class IdiomaItem : IDisposable
        {
            ...
            private static Image CargarBandera(
                string nombreArchivo)
            {
                ...
                foreach (string carpetaInicial
                    in carpetasIniciales)
                {
                ...
                string nombreArchivo)
            {
                ...
                DirectoryInfo carpeta =
                    new DirectoryInfo(carpetaInicial);
